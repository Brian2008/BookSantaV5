...
.then((snapshot)=>{
  ...
  recievedBooks=(bookName)=>{
    ...
    db.collection('recived_books').add({
      "user_id":userId,
  ...
  render(){
    if(this.state.IsBookRequestActive===true){
      ...
      <View style = {{flex:1,justifyContent:'center'}}>
        <View style = {{borderColor:"orange", borderWidth:2,justifyContent:'center',alignItems:'center',padding:30}}>
          <Text>Book Name</Text>
        ...
        <TouchableOpacity style = {{borderColor:"orange", borderWidth:2,justifyContent:'center',alignItems:'center',padding:30, backgroundColor:"peachpuff"}}
        onPress={
          ()=>{
          ...
          <Text>I Have Recived The Book</Text>
          </TouchableOpacity>
      </View>
      )
    }else{
